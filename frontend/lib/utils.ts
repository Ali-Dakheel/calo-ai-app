...
// Format calories
export const formatCalories = (calories: number): string => `${calories} cal`;

// Format macros
export const formatMacros = (protein: number, carbs: number, fats: number): string =>
...
export const getMealCategoryIcon = (category: string): string => {
